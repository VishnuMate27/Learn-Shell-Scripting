...
main() {
    ...
    KEY_NAME="vishnu-learn-shell-script-key"
    SUBNET_ID="subnet-03a3c03c966496bcc"
    SECURITY_GROUP_IDS="sg-0c261bd825cdb867f"  # Add your security group IDs separated by space
